export default async function handler(req, res) {
  ...
  const { topic, targetAudience, contentGoal, tone, affiliateLink } = req.body;
...
Ketentuan Format:
1. Bagi utas menjadi 4-7 tweet/post terpisah, beri nomor (misal: 1/ 2/ dst).
...
4. Sertakan Call to Action (CTA) di bagian akhir.`;
